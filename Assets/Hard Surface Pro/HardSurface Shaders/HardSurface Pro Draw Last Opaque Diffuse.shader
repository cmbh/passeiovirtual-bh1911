...
Shader "HardSurface/Hardsurface Pro/Draw Last/Opaque Diffuse"{
Properties {
	...
	SubShader {
		...
		Tags {"Queue"="Geometry+300" "RenderType"="Opaque" "IgnoreProjector"="False" }
		UsePass "Hidden/Hardsurface Pro Front Opaque Diffuse/FORWARD"
